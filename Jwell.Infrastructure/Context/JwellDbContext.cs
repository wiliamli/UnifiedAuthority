...
namespace Jwell.Repository.Context
{
    public class JwellDbContext: DbContext
    {
        ...
        public IDbSet<ServiceMenu> ServiceMenu { get; set; }

        public IDbSet<EmployeeRoleAndMenu> EmployeeRoleAndMenu { get; set; }

        public IDbSet<EmployeeRole> EmployeeRole { get; set; }

        public IDbSet<AuthSysAccount> AuthSysAccount { get; set; }

        public IDbSet<EmployeeRoleRelation> EmployeeRoleRelation { get; set; }
